...
start:              ; start label from where our code starts
    ...
    start_os_intro db 'Welcome to Namcrosoft OS!',0
    press_key db '>>>> Press any key <<<<',0

    login_username db 'Username : ',0
    login_password db 'Password : ',0
    
    display_text db 'Cannot find TruongTX graphics card!', 0

    os_info db 10, 'Namcrosoft, 16-Bit, version=1.0.0',13,0

    press_key_2 db 10,'Press any key to go to graphics view',0

    window_text db 10,'Namcrosoft 1.0.0......', 0
    hello_world_text db 10,10, '  Welcome Dude!',0
